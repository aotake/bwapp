...
class Form_Validator_Modperm extends Ao_Util_Validator
{
    ...
    public function input(){
        ...
        $error['dirname']['required'] = $this->postRequired('dirname');
        $error['permission']['required'] = $this->postRequired('permission');
        ...
        $error['permission']['int'] = $this->postIsInteger('permission');
