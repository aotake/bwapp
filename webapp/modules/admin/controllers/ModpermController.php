...
if(file_exists($custom_file)){
    ...
    $parentClass = $ModName."_".$CtrName."CustomController";
} else {
    require_once $base_file;
    $parentClass = $BaseModule."_".$CtrName."BaseController";
}

eval('
class '.$ModName.'_'.$CtrName.'Controller extends '.$parentClass.'
{
}
');
